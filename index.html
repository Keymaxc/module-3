...
<html lang="en">
  ...
  <body>
    ...
    style="background-color: rgb(216, 245, 241);">
        <div class="container">
            <a href="#" class="navbar-brand">Dream Sactionary</a>
            ...
            <div class ="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class ="nav-item">
                        <a href="index.html" class ="nav-link actvive" aria-current="page">home</a>
                    </li>
                    <li class ="nav-item">
                        <a href="index.html" class ="nav-link">Dashboard</a>
                    </li>
                    <li class ="nav-item">
                        <a href="index.html" class ="nav-link">Lacak Paket</a>
                    </li>
                </ul>
                <span class="navbar-nav ml-auto" >
                    <form action="" class="container-fluid justify-content-star" >
                        ...
                        <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="col-md-2 col-lg-2 col-xl-2">
                                    <img src="https://artstract.co.uk/cdn/shop/products/Lipstick-Pop-Art-Canvas-Print-2.jpg?v=1547567805" alt="Lipstick Pop Art Canva" class="img-fluid rounded-3">
                                </div>
                                <div class="col-md3 col-lg-3 col-xl-3">
                                    <p class="lead fw-normal mb-2">Lipstick Pop Art Canva</p>
                                    <p><span class="text-muted">Color : </span>Red</p>
                                </div>
                                ...
                                <div class="col-md3 col-lg-2 col-xl-2 offset-lg-1">
                                    <h5 class="mb-0">Rp. 69.000</h5>
                                </div>
